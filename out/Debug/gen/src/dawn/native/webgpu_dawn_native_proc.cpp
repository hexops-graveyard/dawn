...
extern WGPUBool NativeAdapterGetLimits(WGPUAdapter cSelf, WGPUSupportedLimits * limits);
...
extern WGPUBool NativeDeviceGetLimits(WGPUDevice cSelf, WGPUSupportedLimits * limits);
...
extern void NativeSharedFenceReference(WGPUSharedFence cSelf);
extern void NativeSharedFenceRelease(WGPUSharedFence cSelf);
extern void NativeSharedTextureMemoryBeginAccess(WGPUSharedTextureMemory cSelf, WGPUTexture texture, WGPUSharedTextureMemoryBeginAccessDescriptor const * descriptor);
...
extern void NativeSharedTextureMemoryEndAccess(WGPUSharedTextureMemory cSelf, WGPUTexture texture, WGPUSharedTextureMemoryEndAccessState * descriptor);
extern void NativeSharedTextureMemoryGetProperties(WGPUSharedTextureMemory cSelf, WGPUSharedTextureMemoryProperties * properties);
extern void NativeSharedTextureMemorySetLabel(WGPUSharedTextureMemory cSelf, char const * label);
extern void NativeSharedTextureMemoryReference(WGPUSharedTextureMemory cSelf);
...
extern "C" {
    ...
    WGPUBool wgpuAdapterGetLimits(WGPUAdapter cSelf, WGPUSupportedLimits * limits) {
    ...
    WGPUBool wgpuDeviceGetLimits(WGPUDevice cSelf, WGPUSupportedLimits * limits) {
    ...
    void wgpuSharedFenceReference(WGPUSharedFence cSelf) {
        return NativeSharedFenceReference(
            cSelf);
    }
    ...
    void wgpuSharedTextureMemoryBeginAccess(WGPUSharedTextureMemory cSelf, WGPUTexture texture, WGPUSharedTextureMemoryBeginAccessDescriptor const * descriptor) {
    ...
    void wgpuSharedTextureMemoryEndAccess(WGPUSharedTextureMemory cSelf, WGPUTexture texture, WGPUSharedTextureMemoryEndAccessState * descriptor) {
        return NativeSharedTextureMemoryEndAccess(
            cSelf, texture, descriptor);
    }
    void wgpuSharedTextureMemoryGetProperties(WGPUSharedTextureMemory cSelf, WGPUSharedTextureMemoryProperties * properties) {
    ...
    void wgpuSharedTextureMemoryReference(WGPUSharedTextureMemory cSelf) {
        return NativeSharedTextureMemoryReference(
            cSelf);
    }
