...
extern void NativeRenderPassEncoderExecuteBundles(WGPURenderPassEncoder cSelf, uint32_t bundleCount, WGPURenderBundle const * bundles);
...
extern "C" {
    ...
    void wgpuRenderPassEncoderExecuteBundles(WGPURenderPassEncoder cSelf, uint32_t bundleCount, WGPURenderBundle const * bundles) {
