...
namespace dawn::native {
    ...
    WGPUBool NativeAdapterGetLimits(WGPUAdapter cSelf, WGPUSupportedLimits * limits) {
        auto self = FromAPI(cSelf);
    ...
    WGPUBool NativeDeviceGetLimits(WGPUDevice cSelf, WGPUSupportedLimits * limits) {
        auto self = FromAPI(cSelf);
    ...
    void NativeSharedFenceReference(WGPUSharedFence cSelf) {
        auto self = FromAPI(cSelf);
    ...
    void NativeSharedTextureMemoryBeginAccess(WGPUSharedTextureMemory cSelf, WGPUTexture texture, WGPUSharedTextureMemoryBeginAccessDescriptor const * descriptor) {
        auto self = FromAPI(cSelf);
        ...
        self->APIBeginAccess(texture_, descriptor_);
    }
    ...
    void NativeSharedTextureMemoryEndAccess(WGPUSharedTextureMemory cSelf, WGPUTexture texture, WGPUSharedTextureMemoryEndAccessState * descriptor) {
        auto self = FromAPI(cSelf);
        ...
        self->APIEndAccess(texture_, descriptor_);
    }

    void NativeSharedTextureMemoryGetProperties(WGPUSharedTextureMemory cSelf, WGPUSharedTextureMemoryProperties * properties) {
        auto self = FromAPI(cSelf);
    ...
    void NativeSharedTextureMemoryReference(WGPUSharedTextureMemory cSelf) {
        auto self = FromAPI(cSelf);
    ...
    namespace {
        ...
        static const ProcEntry sProcMap[] = {
            ...
            { reinterpret_cast<WGPUProc>(NativeSharedFenceReference), "wgpuSharedFenceReference" },
    ...
    static DawnProcTable gProcTable = MakeProcTable(
        ...
        , std::make_pair(&DawnProcTable::sharedTextureMemoryEndAccessStateFreeMembers, NativeSharedTextureMemoryEndAccessStateFreeMembers)
        ...
        , std::make_pair(&DawnProcTable::deviceImportSharedFence, NativeDeviceImportSharedFence)
        , std::make_pair(&DawnProcTable::deviceImportSharedTextureMemory, NativeDeviceImportSharedTextureMemory)
        ...
        , std::make_pair(&DawnProcTable::sharedFenceExportInfo, NativeSharedFenceExportInfo)
        , std::make_pair(&DawnProcTable::sharedFenceReference, NativeSharedFenceReference)
        , std::make_pair(&DawnProcTable::sharedFenceRelease, NativeSharedFenceRelease)
        , std::make_pair(&DawnProcTable::sharedTextureMemoryBeginAccess, NativeSharedTextureMemoryBeginAccess)
