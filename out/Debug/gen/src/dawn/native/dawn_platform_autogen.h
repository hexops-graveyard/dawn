...
namespace dawn::native {
    ...
    inline const WGPUExternalTextureVisibleRect* ToAPI(const ExternalTextureVisibleRect* rhs) {
        return reinterpret_cast<const WGPUExternalTextureVisibleRect*>(rhs);
    }

    inline WGPUExternalTextureVisibleRect* ToAPI(ExternalTextureVisibleRect* rhs) {
        return reinterpret_cast<WGPUExternalTextureVisibleRect*>(rhs);
    }

    inline const ExternalTextureVisibleRect* FromAPI(const WGPUExternalTextureVisibleRect* rhs) {
        return reinterpret_cast<const ExternalTextureVisibleRect*>(rhs);
    }

    inline ExternalTextureVisibleRect* FromAPI(WGPUExternalTextureVisibleRect* rhs) {
        return reinterpret_cast<ExternalTextureVisibleRect*>(rhs);
    }
