...
namespace dawn::native {
    ...
    inline const wgpu::DawnInstanceDescriptor* ToCppAPI(const DawnInstanceDescriptor* rhs) {
        return reinterpret_cast<const wgpu::DawnInstanceDescriptor*>(rhs);
    }

    inline wgpu::DawnInstanceDescriptor* ToCppAPI(DawnInstanceDescriptor* rhs) {
        return reinterpret_cast<wgpu::DawnInstanceDescriptor*>(rhs);
    }

    inline const DawnInstanceDescriptor* FromCppAPI(const wgpu::DawnInstanceDescriptor* rhs) {
        return reinterpret_cast<const DawnInstanceDescriptor*>(rhs);
    }

    inline DawnInstanceDescriptor* FromCppAPI(wgpu::DawnInstanceDescriptor* rhs) {
        return reinterpret_cast<DawnInstanceDescriptor*>(rhs);
    }
    ...
    inline const wgpu::DawnTogglesDeviceDescriptor* ToCppAPI(const DawnTogglesDeviceDescriptor* rhs) {
        return reinterpret_cast<const wgpu::DawnTogglesDeviceDescriptor*>(rhs);
    }

    inline wgpu::DawnTogglesDeviceDescriptor* ToCppAPI(DawnTogglesDeviceDescriptor* rhs) {
        return reinterpret_cast<wgpu::DawnTogglesDeviceDescriptor*>(rhs);
    }

    inline const DawnTogglesDeviceDescriptor* FromCppAPI(const wgpu::DawnTogglesDeviceDescriptor* rhs) {
        return reinterpret_cast<const DawnTogglesDeviceDescriptor*>(rhs);
    }

    inline DawnTogglesDeviceDescriptor* FromCppAPI(wgpu::DawnTogglesDeviceDescriptor* rhs) {
        return reinterpret_cast<DawnTogglesDeviceDescriptor*>(rhs);
    }
