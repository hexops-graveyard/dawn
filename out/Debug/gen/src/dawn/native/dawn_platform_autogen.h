...
namespace dawn::native {
    ...
    inline const WGPUSharedTextureMemoryVkImageDescriptor* ToAPI(const SharedTextureMemoryVkImageDescriptor* rhs) {
        return reinterpret_cast<const WGPUSharedTextureMemoryVkImageDescriptor*>(rhs);
    }

    inline WGPUSharedTextureMemoryVkImageDescriptor* ToAPI(SharedTextureMemoryVkImageDescriptor* rhs) {
        return reinterpret_cast<WGPUSharedTextureMemoryVkImageDescriptor*>(rhs);
    }

    inline const SharedTextureMemoryVkImageDescriptor* FromAPI(const WGPUSharedTextureMemoryVkImageDescriptor* rhs) {
        return reinterpret_cast<const SharedTextureMemoryVkImageDescriptor*>(rhs);
    }

    inline SharedTextureMemoryVkImageDescriptor* FromAPI(WGPUSharedTextureMemoryVkImageDescriptor* rhs) {
        return reinterpret_cast<SharedTextureMemoryVkImageDescriptor*>(rhs);
    }

    inline const wgpu::SharedTextureMemoryVkImageDescriptor* ToCppAPI(const SharedTextureMemoryVkImageDescriptor* rhs) {
        return reinterpret_cast<const wgpu::SharedTextureMemoryVkImageDescriptor*>(rhs);
    }

    inline wgpu::SharedTextureMemoryVkImageDescriptor* ToCppAPI(SharedTextureMemoryVkImageDescriptor* rhs) {
        return reinterpret_cast<wgpu::SharedTextureMemoryVkImageDescriptor*>(rhs);
    }

    inline const SharedTextureMemoryVkImageDescriptor* FromCppAPI(const wgpu::SharedTextureMemoryVkImageDescriptor* rhs) {
        return reinterpret_cast<const SharedTextureMemoryVkImageDescriptor*>(rhs);
    }

    inline SharedTextureMemoryVkImageDescriptor* FromCppAPI(wgpu::SharedTextureMemoryVkImageDescriptor* rhs) {
        return reinterpret_cast<SharedTextureMemoryVkImageDescriptor*>(rhs);
    }
