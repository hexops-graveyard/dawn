...
namespace dawn::native {
    ...
    template <>
    inline wgpu::SType STypeFor<SharedTextureMemoryVkImageDescriptor> = wgpu::SType::SharedTextureMemoryVkImageDescriptor;
    template <>
    inline wgpu::SType STypeFor<SharedTextureMemoryVkDedicatedAllocationDescriptor> = wgpu::SType::SharedTextureMemoryVkDedicatedAllocationDescriptor;
    template <>
    inline wgpu::SType STypeFor<SharedTextureMemoryAHardwareBufferDescriptor> = wgpu::SType::SharedTextureMemoryAHardwareBufferDescriptor;
    template <>
    inline wgpu::SType STypeFor<SharedTextureMemoryDmaBufDescriptor> = wgpu::SType::SharedTextureMemoryDmaBufDescriptor;
    template <>
    inline wgpu::SType STypeFor<SharedTextureMemoryOpaqueFDDescriptor> = wgpu::SType::SharedTextureMemoryOpaqueFDDescriptor;
    template <>
    inline wgpu::SType STypeFor<SharedTextureMemoryZirconHandleDescriptor> = wgpu::SType::SharedTextureMemoryZirconHandleDescriptor;
    template <>
    inline wgpu::SType STypeFor<SharedTextureMemoryDXGISharedHandleDescriptor> = wgpu::SType::SharedTextureMemoryDXGISharedHandleDescriptor;
    template <>
    inline wgpu::SType STypeFor<SharedTextureMemoryIOSurfaceDescriptor> = wgpu::SType::SharedTextureMemoryIOSurfaceDescriptor;
    template <>
    inline wgpu::SType STypeFor<SharedTextureMemoryEGLImageDescriptor> = wgpu::SType::SharedTextureMemoryEGLImageDescriptor;
    template <>
    inline wgpu::SType STypeFor<SharedTextureMemoryVkImageLayoutBeginState> = wgpu::SType::SharedTextureMemoryVkImageLayoutBeginState;
    template <>
    inline wgpu::SType STypeFor<SharedTextureMemoryVkImageLayoutEndState> = wgpu::SType::SharedTextureMemoryVkImageLayoutEndState;
    template <>
    inline wgpu::SType STypeFor<SharedFenceVkSemaphoreOpaqueFDDescriptor> = wgpu::SType::SharedFenceVkSemaphoreOpaqueFDDescriptor;
    template <>
    inline wgpu::SType STypeFor<SharedFenceVkSemaphoreOpaqueFDExportInfo> = wgpu::SType::SharedFenceVkSemaphoreOpaqueFDExportInfo;
    template <>
    inline wgpu::SType STypeFor<SharedFenceVkSemaphoreSyncFDDescriptor> = wgpu::SType::SharedFenceVkSemaphoreSyncFDDescriptor;
    template <>
    inline wgpu::SType STypeFor<SharedFenceVkSemaphoreSyncFDExportInfo> = wgpu::SType::SharedFenceVkSemaphoreSyncFDExportInfo;
    template <>
    inline wgpu::SType STypeFor<SharedFenceVkSemaphoreZirconHandleDescriptor> = wgpu::SType::SharedFenceVkSemaphoreZirconHandleDescriptor;
    template <>
    inline wgpu::SType STypeFor<SharedFenceVkSemaphoreZirconHandleExportInfo> = wgpu::SType::SharedFenceVkSemaphoreZirconHandleExportInfo;
    template <>
    inline wgpu::SType STypeFor<SharedFenceDXGISharedHandleDescriptor> = wgpu::SType::SharedFenceDXGISharedHandleDescriptor;
    template <>
    inline wgpu::SType STypeFor<SharedFenceDXGISharedHandleExportInfo> = wgpu::SType::SharedFenceDXGISharedHandleExportInfo;
    template <>
    inline wgpu::SType STypeFor<SharedFenceMTLSharedEventDescriptor> = wgpu::SType::SharedFenceMTLSharedEventDescriptor;
    template <>
    inline wgpu::SType STypeFor<SharedFenceMTLSharedEventExportInfo> = wgpu::SType::SharedFenceMTLSharedEventExportInfo;
