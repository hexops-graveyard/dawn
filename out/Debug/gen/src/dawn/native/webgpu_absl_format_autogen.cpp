...
namespace wgpu {
    ...
    AbslFormatConvert(ComputePassTimestampLocation value,
        ...
        break;
            default:
            s->Append(absl::StrFormat("%x", static_cast<typename std::underlying_type<ComputePassTimestampLocation>::type>(value)));
        }
        return {true};
    }
    absl::FormatConvertResult<absl::FormatConversionCharSet::kString>
    ...
    AbslFormatConvert(RenderPassTimestampLocation value,
        ...
        break;
            default:
            s->Append(absl::StrFormat("%x", static_cast<typename std::underlying_type<RenderPassTimestampLocation>::type>(value)));
        }
        return {true};
    }
    absl::FormatConvertResult<absl::FormatConversionCharSet::kString>
