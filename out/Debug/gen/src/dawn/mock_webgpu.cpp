...
namespace {
    ...
    void ForwardComputePassEncoderDispatch(WGPUComputePassEncoder self, uint32_t workgroupCountX, uint32_t workgroupCountY, uint32_t workgroupCountZ) {
        auto object = reinterpret_cast<ProcTableAsClass::Object*>(self);
        return object->procs->ComputePassEncoderDispatch(self, workgroupCountX, workgroupCountY, workgroupCountZ);
    }
    ...
    void ForwardRenderPassEncoderExecuteBundles(WGPURenderPassEncoder self, uint32_t bundleCount, WGPURenderBundle const * bundles) {
        auto object = reinterpret_cast<ProcTableAsClass::Object*>(self);
...
bool ProcTableAsClass::DevicePopErrorScope(WGPUDevice device, WGPUErrorCallback callback, void * userdata) {
    ProcTableAsClass::Object* object = reinterpret_cast<ProcTableAsClass::Object*>(device);
