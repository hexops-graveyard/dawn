...
static WGPUBool ThreadDispatchAdapterGetLimits(WGPUAdapter adapter, WGPUSupportedLimits * limits) {
...
static WGPUBool ThreadDispatchDeviceGetLimits(WGPUDevice device, WGPUSupportedLimits * limits) {
...
static void ThreadDispatchSharedFenceReference(WGPUSharedFence sharedFence) {
    auto* proc = perThreadProcs.sharedFenceReference;
    if (!proc) {
        proc = defaultProc.sharedFenceReference;
    }
    proc(sharedFence);
}
...
static void ThreadDispatchSharedTextureMemoryBeginAccess(WGPUSharedTextureMemory sharedTextureMemory, WGPUTexture texture, WGPUSharedTextureMemoryBeginAccessDescriptor const * descriptor) {
    auto* proc = perThreadProcs.sharedTextureMemoryBeginAccess;
    if (!proc) {
        proc = defaultProc.sharedTextureMemoryBeginAccess;
    }
    proc(sharedTextureMemory, texture, descriptor);
}
...
static void ThreadDispatchSharedTextureMemoryEndAccess(WGPUSharedTextureMemory sharedTextureMemory, WGPUTexture texture, WGPUSharedTextureMemoryEndAccessState * descriptor) {
...
static void ThreadDispatchSharedTextureMemoryGetProperties(WGPUSharedTextureMemory sharedTextureMemory, WGPUSharedTextureMemoryProperties * properties) {
    auto* proc = perThreadProcs.sharedTextureMemoryGetProperties;
    if (!proc) {
        proc = defaultProc.sharedTextureMemoryGetProperties;
    }
    proc(sharedTextureMemory, properties);
}
...
static void ThreadDispatchSharedTextureMemoryReference(WGPUSharedTextureMemory sharedTextureMemory) {
    auto* proc = perThreadProcs.sharedTextureMemoryReference;
    if (!proc) {
        proc = defaultProc.sharedTextureMemoryReference;
    }
...
extern "C" {
    DawnProcTable dawnThreadDispatchProcTable = {
        ...
        ThreadDispatchSharedFenceReference,
