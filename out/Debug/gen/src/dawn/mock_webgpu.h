...
class ProcTableAsClass {
    public:
        ...
        virtual void ComputePassEncoderDispatch(WGPUComputePassEncoder computePassEncoder, uint32_t workgroupCountX, uint32_t workgroupCountY, uint32_t workgroupCountZ) = 0;
        ...
        bool DevicePopErrorScope(WGPUDevice device, WGPUErrorCallback callback, void * userdata);
        virtual bool OnDevicePopErrorScope(WGPUDevice device, WGPUErrorCallback callback, void * userdata) = 0;
        ...
        virtual void RenderPassEncoderExecuteBundles(WGPURenderPassEncoder renderPassEncoder, uint32_t bundleCount, WGPURenderBundle const * bundles) = 0;
...
class MockProcTable : public ProcTableAsClass {
    public:
        ...
        MOCK_METHOD(void, ComputePassEncoderDispatch, (WGPUComputePassEncoder computePassEncoder, uint32_t workgroupCountX, uint32_t workgroupCountY, uint32_t workgroupCountZ), (override));
        ...
        MOCK_METHOD(bool, OnDevicePopErrorScope, (WGPUDevice device, WGPUErrorCallback callback, void * userdata), (override));
        ...
        MOCK_METHOD(void, RenderPassEncoderExecuteBundles, (WGPURenderPassEncoder renderPassEncoder, uint32_t bundleCount, WGPURenderBundle const * bundles), (override));
