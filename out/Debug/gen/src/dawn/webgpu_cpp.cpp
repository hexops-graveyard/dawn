...
namespace wgpu {
    ...
    // ExternalTextureVisibleRect

    static_assert(sizeof(ExternalTextureVisibleRect) == sizeof(WGPUExternalTextureVisibleRect), "sizeof mismatch for ExternalTextureVisibleRect");
    static_assert(alignof(ExternalTextureVisibleRect) == alignof(WGPUExternalTextureVisibleRect), "alignof mismatch for ExternalTextureVisibleRect");

    static_assert(offsetof(ExternalTextureVisibleRect, x) == offsetof(WGPUExternalTextureVisibleRect, x),
            "offsetof mismatch for ExternalTextureVisibleRect::x");
    static_assert(offsetof(ExternalTextureVisibleRect, y) == offsetof(WGPUExternalTextureVisibleRect, y),
            "offsetof mismatch for ExternalTextureVisibleRect::y");
    static_assert(offsetof(ExternalTextureVisibleRect, width) == offsetof(WGPUExternalTextureVisibleRect, width),
            "offsetof mismatch for ExternalTextureVisibleRect::width");
    static_assert(offsetof(ExternalTextureVisibleRect, height) == offsetof(WGPUExternalTextureVisibleRect, height),
            "offsetof mismatch for ExternalTextureVisibleRect::height");
    ...
    static_assert(offsetof(ExternalTextureDescriptor, visibleRect) == offsetof(WGPUExternalTextureDescriptor, visibleRect),
            "offsetof mismatch for ExternalTextureDescriptor::visibleRect");
    ...
    void RenderPassEncoder::ExecuteBundles(uint32_t bundleCount, RenderBundle const * bundles) const {
