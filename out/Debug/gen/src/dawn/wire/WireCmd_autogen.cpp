...
struct WGPUExternalTextureVisibleRectTransfer {
    static_assert(0 <= 1,
                  "Record must be at most one of is_cmd, extensible, and chained.");
...
DAWN_DECLARE_UNUSED size_t WGPUExternalTextureVisibleRectGetExtraRequiredSize(const WGPUExternalTextureVisibleRect& record) {
    DAWN_UNUSED(record);
...
// GetExtraRequiredSize isn't used for structures that are value members of other structures
// because we assume they cannot contain pointers themselves.
DAWN_UNUSED_FUNC(WGPUExternalTextureVisibleRectGetExtraRequiredSize);

DAWN_DECLARE_UNUSED WireResult WGPUExternalTextureVisibleRectSerialize(
    const WGPUExternalTextureVisibleRect& record,
    WGPUExternalTextureVisibleRectTransfer* transfer,
    SerializeBuffer* buffer) {
    DAWN_UNUSED(buffer);
...
DAWN_UNUSED_FUNC(WGPUExternalTextureVisibleRectSerialize);

DAWN_DECLARE_UNUSED WireResult WGPUExternalTextureVisibleRectDeserialize(
    WGPUExternalTextureVisibleRect* record,
    const volatile WGPUExternalTextureVisibleRectTransfer* transfer,
    DeserializeBuffer* deserializeBuffer,
    DeserializeAllocator* allocator) {
    DAWN_UNUSED(allocator);
...
DAWN_UNUSED_FUNC(WGPUExternalTextureVisibleRectDeserialize);
...
WGPUExternalTextureRotation rotation;
    WGPUExternalTextureVisibleRectTransfer visibleRect;
...
float>(memberLength);
    ...
    {
        result += WGPUExternalTextureVisibleRectGetExtraRequiredSize(record.visibleRect);
    }
...
DAWN_DECLARE_UNUSED WireResult WGPUExternalTextureDescriptorSerialize(
    ...
    WIRE_TRY(WGPUExternalTextureVisibleRectSerialize(record.visibleRect, &transfer->visibleRect, buffer));
...
record->rotation = transfer->rotation;
    static_assert(sizeof(record->visibleRect) == sizeof(transfer->visibleRect), "Deserialize memcpy size must match.");
memcpy(&record->visibleRect, const_cast<const WGPUExternalTextureVisibleRectTransfer*>(&transfer->visibleRect), sizeof(WGPUExternalTextureVisibleRectTransfer));
...
DAWN_DECLARE_UNUSED WireResult WGPURenderPassColorAttachmentSerialize(
    ...
    WIRE_TRY(WGPUColorSerialize(record.clearColor, &transfer->clearColor, buffer));
