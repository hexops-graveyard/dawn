...
namespace dawn::wire::server {
    ...
    bool Server::HandleAdapterGetInstance(DeserializeBuffer* deserializeBuffer) {
        ...
        auto* resultData = InstanceObjects().Allocate(cmd.result);
        if (resultData == nullptr) {
            return false;
        }
        resultData->generation = cmd.result.generation;

        bool success = DoAdapterGetInstance(cmd.self, &resultData->handle);
    ...
    bool Server::HandleCommandEncoderBeginComputePass(DeserializeBuffer* deserializeBuffer) {
        ...
        auto* resultData = ComputePassEncoderObjects().Allocate(cmd.result);
        if (resultData == nullptr) {
            return false;
        }
        resultData->generation = cmd.result.generation;
    ...
    bool Server::HandleCommandEncoderBeginRenderPass(DeserializeBuffer* deserializeBuffer) {
        ...
        auto* resultData = RenderPassEncoderObjects().Allocate(cmd.result);
        if (resultData == nullptr) {
            return false;
        }
        resultData->generation = cmd.result.generation;
    ...
    bool Server::HandleCommandEncoderFinish(DeserializeBuffer* deserializeBuffer) {
        ...
        auto* resultData = CommandBufferObjects().Allocate(cmd.result);
        if (resultData == nullptr) {
            return false;
        }
        resultData->generation = cmd.result.generation;
    ...
    bool Server::HandleComputePipelineGetBindGroupLayout(DeserializeBuffer* deserializeBuffer) {
        ...
        auto* resultData = BindGroupLayoutObjects().Allocate(cmd.result);
        if (resultData == nullptr) {
            return false;
        }
        resultData->generation = cmd.result.generation;
    ...
    bool Server::HandleDeviceCreateBindGroup(DeserializeBuffer* deserializeBuffer) {
        ...
        auto* resultData = BindGroupObjects().Allocate(cmd.result);
        if (resultData == nullptr) {
            return false;
        }
        resultData->generation = cmd.result.generation;
    ...
    bool Server::HandleDeviceCreateCommandEncoder(DeserializeBuffer* deserializeBuffer) {
        ...
        auto* resultData = CommandEncoderObjects().Allocate(cmd.result);
        if (resultData == nullptr) {
            return false;
        }
        resultData->generation = cmd.result.generation;
    ...
    bool Server::HandleDeviceCreateComputePipeline(DeserializeBuffer* deserializeBuffer) {
        ...
        auto* resultData = ComputePipelineObjects().Allocate(cmd.result);
        if (resultData == nullptr) {
            return false;
        }
        resultData->generation = cmd.result.generation;
    ...
    bool Server::HandleDeviceCreateErrorBuffer(DeserializeBuffer* deserializeBuffer) {
        ...
        auto* resultData = BufferObjects().Allocate(cmd.result);
        if (resultData == nullptr) {
            return false;
        }
        resultData->generation = cmd.result.generation;

        bool success = DoDeviceCreateErrorBuffer(cmd.self, cmd.descriptor, &resultData->handle);
    ...
    bool Server::HandleDeviceCreateErrorExternalTexture(DeserializeBuffer* deserializeBuffer) {
        ...
        auto* resultData = ExternalTextureObjects().Allocate(cmd.result);
        if (resultData == nullptr) {
            return false;
        }
        resultData->generation = cmd.result.generation;
    ...
    bool Server::HandleDeviceCreateErrorTexture(DeserializeBuffer* deserializeBuffer) {
        ...
        auto* resultData = TextureObjects().Allocate(cmd.result);
        if (resultData == nullptr) {
            return false;
        }
        resultData->generation = cmd.result.generation;
    ...
    bool Server::HandleDeviceCreatePipelineLayout(DeserializeBuffer* deserializeBuffer) {
        ...
        auto* resultData = PipelineLayoutObjects().Allocate(cmd.result);
        if (resultData == nullptr) {
            return false;
        }
        resultData->generation = cmd.result.generation;
    ...
    bool Server::HandleDeviceCreateQuerySet(DeserializeBuffer* deserializeBuffer) {
        ...
        auto* resultData = QuerySetObjects().Allocate(cmd.result);
        if (resultData == nullptr) {
            return false;
        }
        resultData->generation = cmd.result.generation;
    ...
    bool Server::HandleDeviceCreateRenderBundleEncoder(DeserializeBuffer* deserializeBuffer) {
        ...
        auto* resultData = RenderBundleEncoderObjects().Allocate(cmd.result);
        if (resultData == nullptr) {
            return false;
        }
        resultData->generation = cmd.result.generation;
    ...
    bool Server::HandleDeviceCreateRenderPipeline(DeserializeBuffer* deserializeBuffer) {
        ...
        auto* resultData = RenderPipelineObjects().Allocate(cmd.result);
        if (resultData == nullptr) {
            return false;
        }
        resultData->generation = cmd.result.generation;
    ...
    bool Server::HandleDeviceCreateSampler(DeserializeBuffer* deserializeBuffer) {
        ...
        auto* resultData = SamplerObjects().Allocate(cmd.result);
        if (resultData == nullptr) {
            return false;
        }
        resultData->generation = cmd.result.generation;
    ...
    bool Server::HandleDeviceCreateShaderModule(DeserializeBuffer* deserializeBuffer) {
        ...
        auto* resultData = ShaderModuleObjects().Allocate(cmd.result);
        if (resultData == nullptr) {
            return false;
        }
        resultData->generation = cmd.result.generation;
    ...
    bool Server::HandleDeviceCreateSwapChain(DeserializeBuffer* deserializeBuffer) {
        ...
        auto* resultData = SwapChainObjects().Allocate(cmd.result);
        if (resultData == nullptr) {
            return false;
        }
        resultData->generation = cmd.result.generation;
    ...
    bool Server::HandleDeviceForceLoss(DeserializeBuffer* deserializeBuffer) {
        ...
        bool success = DoDeviceForceLoss(cmd.self, cmd.type, cmd.message);
    ...
    bool Server::HandleDeviceGetAdapter(DeserializeBuffer* deserializeBuffer) {
        ...
        auto* resultData = AdapterObjects().Allocate(cmd.result);
        if (resultData == nullptr) {
            return false;
        }
        resultData->generation = cmd.result.generation;
    ...
    bool Server::HandleDeviceGetQueue(DeserializeBuffer* deserializeBuffer) {
        ...
        auto* resultData = QueueObjects().Allocate(cmd.result);
        if (resultData == nullptr) {
            return false;
        }
        resultData->generation = cmd.result.generation;
    ...
    bool Server::HandleDeviceValidateTextureDescriptor(DeserializeBuffer* deserializeBuffer) {
        ...
        bool success = DoDeviceValidateTextureDescriptor(cmd.self, cmd.descriptor);
    ...
    bool Server::HandleExternalTextureExpire(DeserializeBuffer* deserializeBuffer) {
        ...
        bool success = DoExternalTextureExpire(cmd.self);
    ...
    bool Server::HandleExternalTextureRefresh(DeserializeBuffer* deserializeBuffer) {
        ...
        bool success = DoExternalTextureRefresh(cmd.self);
    ...
    bool Server::HandleInstanceCreateSurface(DeserializeBuffer* deserializeBuffer) {
        ...
        auto* resultData = SurfaceObjects().Allocate(cmd.result);
        if (resultData == nullptr) {
            return false;
        }
        resultData->generation = cmd.result.generation;
    ...
    bool Server::HandleInstanceProcessEvents(DeserializeBuffer* deserializeBuffer) {
        ...
        bool success = DoInstanceProcessEvents(cmd.self);
    ...
    bool Server::HandleQueueCopyExternalTextureForBrowser(DeserializeBuffer* deserializeBuffer) {
        ...
        bool success = DoQueueCopyExternalTextureForBrowser(cmd.self, cmd.source, cmd.destination, cmd.copySize, cmd.options);
    ...
    bool Server::HandleRenderBundleEncoderFinish(DeserializeBuffer* deserializeBuffer) {
        ...
        auto* resultData = RenderBundleObjects().Allocate(cmd.result);
        if (resultData == nullptr) {
            return false;
        }
        resultData->generation = cmd.result.generation;
    ...
    bool Server::HandleRenderPassEncoderExecuteBundles(DeserializeBuffer* deserializeBuffer) {
        ...
        bool success = DoRenderPassEncoderExecuteBundles(cmd.self, cmd.bundleCount, cmd.bundles);
    ...
    bool Server::HandleSwapChainGetCurrentTextureView(DeserializeBuffer* deserializeBuffer) {
        ...
        auto* resultData = TextureViewObjects().Allocate(cmd.result);
        if (resultData == nullptr) {
            return false;
        }
        resultData->generation = cmd.result.generation;
        ...
        while (deserializeBuffer.AvailableSize() >= sizeof(CmdHeader) + sizeof(WireCmd)) {
            ...
            switch (cmdId) {
                case WireCmd::AdapterGetInstance:
                    success = HandleAdapterGetInstance(&deserializeBuffer);
                    break;
                ...
                case WireCmd::DeviceForceLoss:
                    success = HandleDeviceForceLoss(&deserializeBuffer);
                    break;
                ...
                case WireCmd::DeviceValidateTextureDescriptor:
                    success = HandleDeviceValidateTextureDescriptor(&deserializeBuffer);
                    break;
                ...
                case WireCmd::ExternalTextureExpire:
                    success = HandleExternalTextureExpire(&deserializeBuffer);
                    break;
                case WireCmd::ExternalTextureRefresh:
                    success = HandleExternalTextureRefresh(&deserializeBuffer);
                    break;
                ...
                case WireCmd::InstanceProcessEvents:
                    success = HandleInstanceProcessEvents(&deserializeBuffer);
                    break;
                ...
                case WireCmd::QueueCopyExternalTextureForBrowser:
                    success = HandleQueueCopyExternalTextureForBrowser(&deserializeBuffer);
                    break;
