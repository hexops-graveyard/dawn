...
namespace dawn::wire::server {
    ...
    bool Server::DoAdapterGetInstance(WGPUAdapter self, WGPUInstance* result) {
        *result =
    ...
    bool Server::DoDeviceCreateErrorBuffer(WGPUDevice self, WGPUBufferDescriptor const * descriptor, WGPUBuffer* result) {
        *result =
    ...
    bool Server::DoDeviceForceLoss(WGPUDevice self, WGPUDeviceLostReason type, char const * message) {
    ...
    bool Server::DoDeviceValidateTextureDescriptor(WGPUDevice self, WGPUTextureDescriptor const * descriptor) {
    ...
    bool Server::DoExternalTextureExpire(WGPUExternalTexture self) {
        
        mProcs.externalTextureExpire(self);
        return true;
    }

    bool Server::DoExternalTextureRefresh(WGPUExternalTexture self) {
    ...
    bool Server::DoInstanceProcessEvents(WGPUInstance self) {
    ...
    bool Server::DoQueueCopyExternalTextureForBrowser(WGPUQueue self, WGPUImageCopyExternalTexture const * source, WGPUImageCopyTexture const * destination, WGPUExtent3D const * copySize, WGPUCopyTextureForBrowserOptions const * options) {
    ...
    bool Server::DoRenderPassEncoderExecuteBundles(WGPURenderPassEncoder self, uint32_t bundleCount, WGPURenderBundle const * bundles) {
