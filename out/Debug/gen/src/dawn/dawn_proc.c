...
void wgpuSharedTextureMemoryBeginAccess(WGPUSharedTextureMemory sharedTextureMemory, WGPUTexture texture, WGPUSharedTextureMemoryBeginAccessDescriptor const * descriptor) {
    procs.sharedTextureMemoryBeginAccess(sharedTextureMemory, texture, descriptor);
}
...
void wgpuSharedTextureMemoryEndAccess(WGPUSharedTextureMemory sharedTextureMemory, WGPUTexture texture, WGPUSharedTextureMemoryEndAccessState * descriptor) {
    procs.sharedTextureMemoryEndAccess(sharedTextureMemory, texture, descriptor);
}
