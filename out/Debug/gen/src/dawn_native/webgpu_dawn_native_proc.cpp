...
extern void NativeComputePassEncoderDispatch(WGPUComputePassEncoder cSelf, uint32_t x, uint32_t y, uint32_t z);
...
extern uint32_t NativeDeviceEnumerateFeatures(WGPUDevice cSelf, WGPUFeatureName * features);
...
extern "C" {
    ...
    void wgpuComputePassEncoderDispatch(WGPUComputePassEncoder cSelf, uint32_t x, uint32_t y, uint32_t z) {
    ...
    uint32_t wgpuDeviceEnumerateFeatures(WGPUDevice cSelf, WGPUFeatureName * features) {
