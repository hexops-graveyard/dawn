...
namespace dawn_native {
    ...
    inline const WGPUSurfaceDescriptorFromXlib* ToAPI(const SurfaceDescriptorFromXlib* rhs) {
        return reinterpret_cast<const WGPUSurfaceDescriptorFromXlib*>(rhs);
    }

    inline WGPUSurfaceDescriptorFromXlib* ToAPI(SurfaceDescriptorFromXlib* rhs) {
        return reinterpret_cast<WGPUSurfaceDescriptorFromXlib*>(rhs);
    }

    inline const SurfaceDescriptorFromXlib* FromAPI(const WGPUSurfaceDescriptorFromXlib* rhs) {
        return reinterpret_cast<const SurfaceDescriptorFromXlib*>(rhs);
    }

    inline SurfaceDescriptorFromXlib* FromAPI(WGPUSurfaceDescriptorFromXlib* rhs) {
        return reinterpret_cast<SurfaceDescriptorFromXlib*>(rhs);
    }
